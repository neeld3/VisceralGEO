  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-start">
      ...
      <div className="mt-12 w-md flex flex-col items-center justify-center"> {/* Updated parent container */}
        ...
        />
        <h1 className="text-4xl font-bold text-center"><br /><br />Paint a picture of knowledge. Turn your passions into profit one stroke at a time.</h1>
        <p className="mt-8 max-w-fill text-left" style={{ marginLeft: '10%', marginRight: '10%' }}>
